...
var addButton=document.querySelector(".todo-list__button_add");
// var addButton=document.querySelector(".todo-list__button_add");//first button
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="todo-list__input todo-list__input_edit";
    ...
    deleteButtonImg.className = "todo-list__img";
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.classList.add("todo-list__item_completed")
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.classList.remove("todo-list__item_completed")
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
